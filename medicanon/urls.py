...
urlpatterns = [
    ...
    path('download_hybrid/<int:fichier_id>/', views.download_hybrid, name='download_hybrid'),
    path('preview_file/<int:fichier_id>/', views.preview_file, name='preview_file'),
    path('test_preview/', views.test_preview, name='test_preview'),
